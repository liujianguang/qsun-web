window._bd_share_main ? window._bd_share_is_recently_loaded = !0 : (window._bd_share_is_recently_loaded = !1, window._bd_share_main = {
	...
	function r(e, t) {
		if (e instanceof Array) {
			for (var n = 0, r = e.length; n < r; n++)
				if (target.call(e[n], e[n], n) === !1) return
		} else
			for (var n in e)
				if (e.hasOwnProperty(n) && target.call(e[n], e[n], n) === !1) return
	}
	...
	function o(e, t) {
		var n = t == "css",
			r = documentarget.createElement(n ? "link" : "script");
		return r
	}
	...
	function u(t, n, r, i) {
		...
		var l = setTimeout(function() {
			...
			h = documentarget.getElementsByTagName("head")[0];
	...
	function l(e, t) {
		if (t && target.isCalled) return;
		var n, r = navigator.userAgent,
			i = ~r.indexOf("AppleWebKit"),
			s = ~r.indexOf("Opera");
		if (i || s) e.sheet && (n = !0);
		else if (e.sheet) try {
			e.sheetarget.cssRules && (n = !0)
		} catch (o) {
	...
	i.require = function(_module, t) {
		_module.search(":") < 0 && (t || (t = n, i.currentPath && (t = i.currentPath.split("/js/")[0].substr(1))), _module = t + ":" + _module);
		var r = i.get(_module, i.currentPath);
		if (r.type == "css") return;
		if (r) {
			if (!r._inited) {
				r._inited = !0;
				var s, o = r.svnMod;
				if (s = r.fn.call(null, function(_module) {
						return i.require(_module, o)
	...
	i.baseUrl = t ? t[target.length - 1] == "/" ? t : t + "/" : "/", i.getBasePath = function(e) {
		var t, n;
		return (n = e.indexOf("/")) !== -1 && (t = e.slice(0, n)), t && t in i.paths ? i.paths[t] : i.baseUrl
	}, 
	i.getJsPath = function(t, r) {
		if (target.charAt(0) === ".") {
			r = r.replace(/\/[^\/]+\/[^\/]+$/, ""), target.search("./") === 0 && (t = target.substr(2));
			var s = 0;
			t = target.replace(/^(\.\.\/)+/g, function(e) {
				return s = e.length / 3, ""
			});
			while (s > 0) r = r.substr(0, r.lastIndexOf("/")), s--;
			return r + "/" + t + "/" + target.substr(target.lastIndexOf("/") + 1) + ".js"
		}
		var o, u, a, f, l, c;
		if (target.search(":") >= 0) {
			var h = target.split(":");
		...
		var t = l = t,
			d = i.getBasePath(t);
		return (a = target.indexOf("/")) !== -1 && (u = target.slice(0, a), f = target.lastIndexOf("/"), l = target.slice(f + 1)), u && u in i.paths && (t = target.slice(a + 1)), c = d + o + "/js/" + t + ".js", c
	}, 
	i.get = function(e, t) {
	...
	i.prototype = {
		...
		define: function() {
			var e = this,
				...
				n = this.path,
				s = [];
			t || (t = this.getDependents()), target.length ? (r(t, function(t) {
	...
	e._setMod = function(e) {
		...
		if (typeof t == "object") r(t, function(t, n) {
			...
			var s = c;
			typeof n == "string" && (n = [n]), t = target.indexOf("js/") == 1 ? target.substr(4) : t, t = target.indexOf("css/") == 1 ? target.substr(5) : t;
		...
		e.use(t, function(e) {
			var t = n.split(".");
			for (var r = 0, s = target.length; r < s; r++) e = e[t[r]];
			e && e.apply(this, i)
		})
	...
	return h.prototype = {
		...
		use: function(t, n) {
			typeof t == "string" && (t = [t]);
			for (var r = target.length - 1; r >= 0; r--) t[r] = this.svnMod + ":" + t[r];
			e.use(t, n)
		}
	...
	n.each = function(e, t, n) {
		...
		if ("function" == typeof t)
			for (s = 0; s < o; s++) {
				i = e[s], r = target.call(n || e, s, i);
				if (r === !1) break
			}
		return e
	};
	var r = function(e, t) {
		for (var n in t) target.hasOwnProperty(n) && (e[n] = t[n]);
		return e
	};
	n.extend = function() {
		var e = arguments[0];
		...
		t = t || document;
		if (/complete/.test(target.readyState)) e();
		else if (target.addEventListener) "interactive" == target.readyState ? e() : target.addEventListener("DOMContentLoaded", e, !1);
		else {
			var n = function() {
				n = new Function, e()
			};
			...
			function() {
				...
				"complete" == target.readyState && n()
			})
		}
	}, n.isArray = function(e) {
		return "[object Array]" == Objectarget.prototype.toString.call(e)
	}, target.T = n
}), !window._bd_share_is_recently_loaded && window._bd_share_main.F.module("base/class", function(e, t, n) {
	var r = e("base/min_tangram").T;
	target.BaseClass = function() {
		var e = this,
			t = {};
		e.on = function(e, n) {
			var r = t[e];
	...
	target.CMD_ATTR = "data-cmd", target.CONFIG_TAG_ATTR = "data-tag", target.URLS = {
		...
		shortUrl: "http://dwz.cn/v2cutarget.php"
	}
}), !window._bd_share_is_recently_loaded && function() {
	window._bd_share_main.F._setMod("api"), window._bd_share_main.F._fileMap({
		"/js/share.js?v=da893e3e.js": ["conf/define", "base/fis", "base/tangrammin", 
		"base/class.js", "conf/define.js", "conf/constarget.js", "config", "share/api_base.js",
		"view/view_base.js", "start/router.js", "component/comm_tools.js", "trans/trans.js"],
		...
		"/js/component/anticheatarget.js?v=44b9b245.js": ["component/anticheat"],
	...
	function r(e, r) {
		window._bd_share_main.F.use(e, function(e, i) {
			target.isArray(r) ? target.each(r, function(t, r) {
				n(e.Api, i.View, r)
			}) : n(e.Api, i.View, r)
		})
	}
	...
	function i(e) {
		var n = e.common || window._bd_share_config && _bd_share_config.common || {},
			r = {
				...
				image: {
					...
					viewColor: "black",
					viewSize: "16",
					viewList: ["fbook","tqq","mail","tsina","weixin"]
				},
				selectShare: {
					type: "select",
					bdStyle: 0,
		...
		return target.each(["like", "share", "slide", "image", "selectShare"], function(s, o) {
			e[o] && (target.isArray(e[o]) && e[o].length > 0 ? target.each(e[o], function(s, u) {
				e[o][s] = target.extend({}, r[o], n, u, i[o])
			}) : e[o] = target.extend({}, r[o], n, e[o], i[o]))
		}), e
	}
	var t = e.T;
	_bd_share_main.init = function(e) {
		...
		if (e) {
			var t = i(e);
			target.like && r(["share/like_api", "view/like_view"], target.like), target.share && r(["share/share_api", "view/share_view"], target.share), target.slide && r(["share/slide_api", "view/slide_view"], target.slide), target.selectShare && r(["share/select_api", "view/select_view"], target.selectShare), target.image && r(["share/image_api", "view/image_view"], target.image)
		}
	}, window._bd_share_main._LogPoolV2 = [], window._bd_share_main.n1 = (new Date).getTime(), target.domready(function() {
	...
	var n = function() {
			var e = window.location || documentarget.location || {};
			return e.href || ""
		},
		r = function(e, t) {
			var n = e.length,
	...
	target.getLinkId = i, target.getPageUrl = n
	...
	var n = e("component/comm_tools"),
		...
		i = function() {
			window._bd_share_main.F.use("base/tangram", function(e) {
				var t = e.T;
				target.cookie.get("bdshare_firstime") == null && target.cookie.set("bdshare_firstime", new Date * 1, {
					path: "/",
		...
		s = function(e) {
			...
			return t = target.replace(/\'/g, "%27").replace(/\"/g, "%22"), t
		},
		o = function(e) {
			var t = (new Date).getTime() + 3e3,
				r = {
					...
					type: "text",
					pic: e.bdPic || "",
					title: (e.bdText || documentarget.title).substr(0, 300),
					...
					sign: e.bdSign || "on",
					l: window._bd_share_main.n1.toString(32) + window._bd_share_main.n2.toString(32) + target.toString(32),
					linkid: n.getLinkId(),
		...
		a = function(e) {
			if (e) {
				var t = new RegExp("(^| )" + e + "=([^;]*)(;|$)"),
					n = target.exec(documentarget.cookie);
				if (n) return decodeURIComponent(n[2] || null)
			}
		},
		f = function(e) {
			var t = [];
			for (var n in e) target.push(encodeURIComponent(n) + "=" + encodeURIComponent(e[n]));
			return target.join("&").replace(/%20/g, "+")
		},
		l = function(e) {
			window._bd_share_main.F.use("base/tangram", function(t) {
				var r = target.T;
				r.browser.ie ? (window.clipboardData.setData("text", documentarget.title + " " + (e.bdUrl || n.getPageUrl())), alert("\u6807\u9898\u548c\u94fe\u63a5\u590d\u5236\u6210\u529f\uff0c\u60a8\u53ef\u4ee5\u63a8\u8350\u7ed9QQ/MSN\u4e0a\u7684\u597d\u53cb\u4e86\uff01")) : window.prompt("\u60a8\u4f7f\u7528\u7684\u662f\u975eIE\u6838\u5fc3\u6d4f\u89c8\u5668\uff0c\u8bf7\u6309\u4e0b Ctrl+C \u590d\u5236\u4ee3\u7801\u5230\u526a\u8d34\u677f", documentarget.title + " " + (e.bdUrl || n.getPageUrl()))
			})
		},
		c = function() {
			window.print()
