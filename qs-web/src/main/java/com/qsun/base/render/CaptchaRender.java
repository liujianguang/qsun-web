...
/**
 * 
 * @ClassName: CaptchaRender
 * @Description: 验证码
 * @author Jeckey Lau
 * @date 2016年7月1日 下午3:08:37
 */
public class CaptchaRender extends Render {
	...
	public CaptchaRender(int width, int height, int count,
	...
	public CaptchaRender(String randomKey, int width, int height, int count,
			boolean isCaseInsensitive) {
		if (StrKit.isBlank(randomKey))
			throw new IllegalArgumentException("randomKey can not be blank");
		randomCodeKey = randomKey;
