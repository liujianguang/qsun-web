package com.qsun.core.plugin.annotation;
...
import com.qsun.core.kit.ClassSearcherKit;
...
public class ControlPlugin implements IPlugin {
	...
	public boolean start() {
		...
		List<Class<? extends BaseController>> controllerClasses = ClassSearcherKit
				.of(BaseController.class).search();
		// List<String> jars = new ArrayList<>();
		// jars.add("littleant.jar");
		// ToolClassSearcher.of(BaseController.class).includeAllJarsInLib(true).injars(jars).search();//
