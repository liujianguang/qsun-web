...
import com.qsun.base.common.MyBeetlRenderFactory;
import com.qsun.core.plugin.annotation.ControlPlugin;
import com.qsun.core.plugin.annotation.TablePlugin;
import com.qsun.core.plugin.sqlxml.SqlXmlPlugin;
import com.qsun.tools.DevConstants;
...
public class SystemConfig extends JFinalConfig {
	...
	public void configPlugin(Plugins me) {
		...
		System.out.println("jdbcUrl:" + getProperty("jdbcUrl"));
		System.out.println("user:" + getProperty("user"));
